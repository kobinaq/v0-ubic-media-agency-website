...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Contact Ubic Media Agency in Accra to discuss web design, web app development, marketing consultation, or media production. We reply within one working day.",
  path: "/contact",
